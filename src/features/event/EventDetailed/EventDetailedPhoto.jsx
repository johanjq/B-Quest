...
class EventDetailedPhoto extends Component {
    ...
    render() {
        return (
            <Segment>
                <Header dividing size='large' content='Drop Your Treasure Hunt Photo Proof Here' />
                <Grid>
                    <Grid.Row />
                    <Grid.Column width={4}>
                ...
                <Card.Group itemsPerRow={5}>
                    <Card>
                        <Image src='https://bit.ly/2HDmTHG'/>
                        <Button positive>Main Photo</Button>
                    </Card>

                        <Card >
                            <Image
                                src='https://bit.ly/2HDrEkL'
                            />
...
export default EventDetailedPhoto;